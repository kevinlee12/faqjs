...
},{"jquery":12,"hammerjs":6}],10:[function(require,module,exports) {
'use strict';
...
},{"./dist":10}],11:[function(require,module,exports) {
'use strict';
...
},{"inferno":8}],9:[function(require,module,exports) {
module.exports = require('./dist').default;
module.exports.default = module.exports;


},{"./dist":11}],3:[function(require,module,exports) {
"use strict";
...
var Navbar = function (_Component) {
  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      return createVNode(2, "div", "navbar-fixed", createVNode(2, "nav", null, createVNode(2, "div", "nav-wrapper", [createVNode(2, "div", "brand-logo left", "FAQ"), createVNode(2, "ul", "right hide-on-med-and-down", [createVNode(2, "li", null, createVNode(2, "a", null, "Users", {
        "href": "#"
      })), createVNode(2, "li", null, createVNode(2, "a", null, "Threads", {
        "href": "#"
      }))], {
        "id": "nav-mobile"
      })])));
...
},{"inferno":8,"inferno-component":9}],5:[function(require,module,exports) {
"use strict";
...
var threadEditUrl = '/admin/thread';
var threadCreateUrl = '/admin/thread/create';
var threadDeleteUrl = '/admin/thread/delete';

var createVNode = _inferno2.default.createVNode;

var ThreadModal = function (_Component) {
  _inherits(ThreadModal, _Component);

  function ThreadModal(props) {
    _classCallCheck(this, ThreadModal);

    var _this = _possibleConstructorReturn(this, (ThreadModal.__proto__ || Object.getPrototypeOf(ThreadModal)).call(this, props));
  ...
  _createClass(ThreadModal, [{
    ...
    value: function render() {
      ...
      return createVNode(2, "div", "modal modal-fixed-footer", [createVNode(2, "div", "modal-content", createVNode(2, "div", "row", [this.props.onUpdate ? createVNode(2, "h4", null, " Modify a Thread ") : createVNode(2, "h4", null, " Create a Thread "), createVNode(2, "div", "col s12", createVNode(2, "div", "row", [createVNode(2, "div", "input-field col s12", [createVNode(512, "input", null, null, {
        "id": "thread_question",
        "type": "text",
        "onInput": this.handleQuestionChange.bind(this),
        "value": this.state.question
      }), this.state.question ? createVNode(2, "label", "active", "Question", {
        "for": "thread_question"
      }) : createVNode(2, "label", null, "Question", {
        "for": "thread_question"
      })]), createVNode(2, "div", "input-field col s12", [createVNode(1024, "textarea", "materialize-textarea", null, {
        "id": "thread_answer",
        "type": "text",
        "onInput": this.handleAnswerChange.bind(this),
        "value": this.state.answer
      }), this.state.answer ? createVNode(2, "label", "active", "Answer", {
        "for": "thread_answer"
      }) : createVNode(2, "label", null, "Answer", {
        "for": "thread_answer"
      })])]))])), createVNode(2, "div", "modal-footer", [this.props.onDelete ? createVNode(2, "button", "modal-action modal-close waves-effect waves-red btn-flat red lighten-5", "Delete Thread", {
        "onClick": this.deleteThread.bind(this)
      }) : null, createVNode(2, "button", "modal-action modal-close waves-effect waves-grey btn-flat", "Cancel"), this.props.onUpdate ? createVNode(2, "button", "modal-action modal-close waves-effect waves-green btn-flat green lighten-5", "Save Changes", {
        "onClick": this.sendEdits.bind(this)
      }) : null, this.props.onCreate ? createVNode(2, "button", "modal-action modal-close waves-effect waves-green btn-flat green lighten-5", "Create Thread", {
...
var ThreadModalContainer = function (_Component2) {
  _inherits(ThreadModalContainer, _Component2);

  function ThreadModalContainer(props) {
    _classCallCheck(this, ThreadModalContainer);

    return _possibleConstructorReturn(this, (ThreadModalContainer.__proto__ || Object.getPrototypeOf(ThreadModalContainer)).call(this, props));
  }

  _createClass(ThreadModalContainer, [{
    ...
    value: function render() {
      var that = this;
      var resultModals = this.props.threads.map(function (item, index) {
        return createVNode(16, ThreadModal, null, null, {
          "identifier": item._id,
      ...
      return createVNode(2, "div", null, [resultModals, createVNode(16, ThreadModal, null, null, {
...
},{"inferno":8,"inferno-component":9}],2:[function(require,module,exports) {
"use strict";
...
var _threadEditModal = require("./threadEditModal");

var _threadEditModal2 = _interopRequireDefault(_threadEditModal);
...
var Thread = function (_Component) {
  ...
  _createClass(Thread, [{
    ...
    value: function render() {
      var modalHref = '#m' + this.props.identifier;
      return createVNode(2, "tr", "modal-trigger", [createVNode(2, "td", null, [" ", this.props.question, " "]), createVNode(2, "td", null, [" ", this.props.answer, " "])], {
        "href": modalHref
      });
    }
  }]);
...
var ThreadContainer = function (_Component2) {
  _inherits(ThreadContainer, _Component2);

  function ThreadContainer(props) {
    _classCallCheck(this, ThreadContainer);

    return _possibleConstructorReturn(this, (ThreadContainer.__proto__ || Object.getPrototypeOf(ThreadContainer)).call(this, props));
  }

  _createClass(ThreadContainer, [{
    key: "render",
    value: function render() {
      var threads = this.props.threads.map(function (item) {
        return createVNode(16, Thread, null, null, {
          "identifier": item._id,
          "question": item.question,
          "answer": item.answer
        });
      });
      return createVNode(2, "table", "bordered highlight", [createVNode(2, "thead", null, createVNode(2, "tr", null, [createVNode(2, "th", null, " Question "), createVNode(2, "th", null, " Answer ")])), createVNode(2, "tbody", null, threads)]);
    }
  }]);
...
var ThreadAdmin = function (_Component3) {
  _inherits(ThreadAdmin, _Component3);

  function ThreadAdmin(props) {
    _classCallCheck(this, ThreadAdmin);

    var _this3 = _possibleConstructorReturn(this, (ThreadAdmin.__proto__ || Object.getPrototypeOf(ThreadAdmin)).call(this, props));
  ...
  _createClass(ThreadAdmin, [{
    ...
    key: "updateThread",
    value: function updateThread(threadObj) {
      var that = this;
      this.state.threads.map(function (item, index) {
        if (item._id === threadObj._id) {
          ...
          var tempState = that.state.threads;
    ...
    key: "deleteThread",
    value: function deleteThread(threadObj) {
      var that = this;
      this.state.threads.map(function (item, index) {
        if (item._id === threadObj._id) {
          var tempState = that.state.threads;
    ...
    key: "createThread",
    value: function createThread(threadObj) {
      var updatedStateThreads = this.state.threads;
    ...
    key: "render",
    value: function render() {
      return createVNode(2, "div", null, [createVNode(2, "h3", "admin-header", " Thread Managment "), createVNode(2, "a", "btn-flat modal-trigger btn-flat waves-effect waves-green green lighten-5", "Create Thread", {
        "href": "#mcreateModal"
      }), createVNode(16, ThreadContainer, null, null, {
        "threads": this.state.threads
      }), createVNode(16, _threadEditModal2.default, null, null, {
        "threads": this.state.threads,
...
},{"inferno":8,"inferno-component":9,"./threadEditModal":5}],4:[function(require,module,exports) {
"use strict";
...
var UsersAdmin = function (_Component) {
  _inherits(UsersAdmin, _Component);

  function UsersAdmin(props) {
    _classCallCheck(this, UsersAdmin);

    return _possibleConstructorReturn(this, (UsersAdmin.__proto__ || Object.getPrototypeOf(UsersAdmin)).call(this, props));
  }

  _createClass(UsersAdmin, [{
    key: "render",
    value: function render() {
      return createVNode(2, "div", null, createVNode(2, "h1", null, " Users "));
    }
  }]);
...
},{"inferno":8,"inferno-component":9}],1:[function(require,module,exports) {
"use strict";
...
var _threadAdmin = require("./threadAdmin");

var _threadAdmin2 = _interopRequireDefault(_threadAdmin);
...
var AdminPageApp = function (_Component) {
  _inherits(AdminPageApp, _Component);

  function AdminPageApp(props) {
    _classCallCheck(this, AdminPageApp);

    var _this = _possibleConstructorReturn(this, (AdminPageApp.__proto__ || Object.getPrototypeOf(AdminPageApp)).call(this, props));
  ...
  _createClass(AdminPageApp, [{
    key: "render",
    value: function render() {
      var adminContent = createVNode(16, _threadAdmin2.default);
      if (this.state.currentTab === 'users') {
        createVNode(16, UsersAdmin);
      }
      return createVNode(2, "div", null, [createVNode(16, _navbar2.default), createVNode(2, "div", "container", adminContent, {
...
_inferno2.default.render(createVNode(16, AdminPageApp), document.getElementById('app'));
},{"hammerjs":6,"materialize-css":7,"inferno":8,"inferno-component":9,"./navbar":3,"./threadAdmin":2,"./userAdmin":4}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:39475/');
